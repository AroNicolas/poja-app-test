...
import org.org.school.conf.FacadeIT;
import org.org.school.endpoint.event.consumer.model.ConsumableEvent;
import org.org.school.endpoint.event.consumer.model.ConsumableEventTyper;
import org.org.school.endpoint.event.consumer.model.TypedEvent;
import org.org.school.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("org.org.school.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("org.org.school.endpoint.event.model.UuidCreated", payload);
